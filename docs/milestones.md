...
- **Latest**: v1.107.0 (feat: Retry Failed Tasks `--retry-failed` + sailor v2.60.0) — RELEASED 2026-06-27
- **Pending release**: —
...
- **Current in zr**: v2.61.0 (all migrations complete through v2.61.0)
- **Next**: v2.62.0+ (when released)
...
| v2.61.0 | DONE | KanbanBoard widget — multi-column task board, priority levels (critical/high/normal/low), card navigation (Cycle 371 FEATURE, v1.108.0, issue #106) |

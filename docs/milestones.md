...
- **Latest**: v1.76.0 (Task Conditional Dependencies Enhancement)
- **Active milestones**: 0 READY + 2 BLOCKED
- **READY milestones**: 0 (Enhanced Task Filtering & Selection Patterns completed, ready for v1.77.0 release)

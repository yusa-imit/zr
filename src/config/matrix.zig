...
pub fn addMatrixTask(
    ...
    if (dims.items.len == 0 or cmd.len == 0) {
        return addTaskImpl(config, allocator, name, cmd, cwd, description, null, null, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, deps, deps_serial, &[_]types.ConditionalDep{}, &[_][]const u8{}, env, timeout_ms, allow_failure, retry_max, retry_delay_ms, retry_backoff, condition, null, null, max_concurrent, cache, max_cpu, max_memory, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, &[_][2][]const u8{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{}, &[_][]const u8{}, &[_][]const u8{}, null, true, false, null, null, &[_][]const u8{}, &[_][]const u8{}, false, &[_]types.InputPrompt{}, &[_][]const u8{}, null, null, false, 0, null, false, null, &[_]u8{}, &[_][]const u8{}, null);
    }
    ...
    while (variant_idx < total) : (variant_idx += 1) {
        ...
        try addTaskImpl(config, allocator, vname, v_cmd, v_cwd, v_desc, null, null, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, deps, deps_serial, &[_]types.ConditionalDep{}, &[_][]const u8{}, v_env_list.items, timeout_ms, allow_failure, retry_max, retry_delay_ms, retry_backoff, condition, null, null, max_concurrent, cache, max_cpu, max_memory, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, &[_][2][]const u8{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{}, &[_][]const u8{}, &[_][]const u8{}, null, true, false, null, null, &[_][]const u8{}, &[_][]const u8{}, false, &[_]types.InputPrompt{}, &[_][]const u8{}, null, null, false, 0, null, false, null, &[_]u8{}, &[_][]const u8{}, null);
    ...
    try addTaskImpl(config, allocator, name, meta_cmd, null, description, null, null, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, variant_names.items, &[_][]const u8{}, &[_]types.ConditionalDep{}, &[_][]const u8{}, &[_][2][]const u8{}, null, false, 0, 0, false, null, null, null, 0, false, null, null, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, &[_][2][]const u8{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{}, &[_][]const u8{}, &[_][]const u8{}, null, true, false, null, null, &[_][]const u8{}, &[_][]const u8{}, false, &[_]types.InputPrompt{}, &[_][]const u8{}, null, null, false, 0, null, false, null, &[_]u8{}, &[_][]const u8{}, null);
}

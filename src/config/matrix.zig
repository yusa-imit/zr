...
pub fn addMatrixTask(
    ...
    if (dims.items.len == 0 or cmd.len == 0) {
        return addTaskImpl(config, allocator, name, cmd, cwd, description, deps, deps_serial, &[_]types.ConditionalDep{}, &[_][]const u8{}, env, timeout_ms, allow_failure, retry_max, retry_delay_ms, retry_backoff, condition, null, null, max_concurrent, cache, max_cpu, max_memory, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{});
    }
    ...
    while (variant_idx < total) : (variant_idx += 1) {
        ...
        try addTaskImpl(config, allocator, vname, v_cmd, v_cwd, v_desc, deps, deps_serial, &[_]types.ConditionalDep{}, &[_][]const u8{}, v_env_list.items, timeout_ms, allow_failure, retry_max, retry_delay_ms, retry_backoff, condition, null, null, max_concurrent, cache, max_cpu, max_memory, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{});
    ...
    try addTaskImpl(config, allocator, name, meta_cmd, null, description, variant_names.items, &[_][]const u8{}, &[_]types.ConditionalDep{}, &[_][]const u8{}, &[_][2][]const u8{}, null, false, 0, 0, false, null, null, null, 0, false, null, null, &[_][]const u8{}, &[_][]const u8{}, &[_]u32{}, null, null, &[_][]const u8{}, &[_][]const u8{}, null, &[_]types.TaskHook{}, null, &[_][2][]const u8{}, null, null, null, null, &[_][2][]const u8{}, &[_][]const u8{}, &[_][]const u8{}, false, &[_][]const u8{}, &[_][]const u8{}, &[_]types.TaskParam{});
}
